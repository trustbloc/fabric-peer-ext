...
import (
	...
	supportapi "github.com/trustbloc/fabric-peer-ext/extensions/collections/api/support"
	gossipapi "github.com/trustbloc/fabric-peer-ext/extensions/gossip/api"
)

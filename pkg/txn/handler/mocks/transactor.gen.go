...
func (fake *Transactor) CreateTransaction(request fab.TransactionRequest) (*fab.Transaction, error) {
...
func (fake *Transactor) CreateTransactionCallCount() int {
	fake.createTransactionMutex.RLock()
	defer fake.createTransactionMutex.RUnlock()
	return len(fake.createTransactionArgsForCall)
}

func (fake *Transactor) CreateTransactionArgsForCall(i int) fab.TransactionRequest {
	fake.createTransactionMutex.RLock()
	defer fake.createTransactionMutex.RUnlock()
	return fake.createTransactionArgsForCall[i].request
}

func (fake *Transactor) CreateTransactionReturns(result1 *fab.Transaction, result2 error) {
...
func (fake *Transactor) CreateTransactionReturnsOnCall(i int, result1 *fab.Transaction, result2 error) {
	fake.CreateTransactionStub = nil
...
func (fake *Transactor) SendTransaction(tx *fab.Transaction) (*fab.TransactionResponse, error) {
...
func (fake *Transactor) SendTransactionCallCount() int {
	fake.sendTransactionMutex.RLock()
	defer fake.sendTransactionMutex.RUnlock()
	return len(fake.sendTransactionArgsForCall)
}

func (fake *Transactor) SendTransactionArgsForCall(i int) *fab.Transaction {
	fake.sendTransactionMutex.RLock()
	defer fake.sendTransactionMutex.RUnlock()
	return fake.sendTransactionArgsForCall[i].tx
}

func (fake *Transactor) SendTransactionReturns(result1 *fab.TransactionResponse, result2 error) {
...
func (fake *Transactor) SendTransactionReturnsOnCall(i int, result1 *fab.TransactionResponse, result2 error) {
	fake.SendTransactionStub = nil
...
func (fake *Transactor) CreateTransactionHeader(opts ...fab.TxnHeaderOpt) (fab.TransactionHeader, error) {
...
func (fake *Transactor) CreateTransactionHeaderCallCount() int {
...
func (fake *Transactor) CreateTransactionHeaderArgsForCall(i int) []fab.TxnHeaderOpt {
	fake.createTransactionHeaderMutex.RLock()
	defer fake.createTransactionHeaderMutex.RUnlock()
	return fake.createTransactionHeaderArgsForCall[i].opts
}

func (fake *Transactor) CreateTransactionHeaderReturns(result1 fab.TransactionHeader, result2 error) {
...
func (fake *Transactor) CreateTransactionHeaderReturnsOnCall(i int, result1 fab.TransactionHeader, result2 error) {
	fake.CreateTransactionHeaderStub = nil
...
func (fake *Transactor) SendTransactionProposal(arg1 *fab.TransactionProposal, arg2 []fab.ProposalProcessor) ([]*fab.TransactionProposalResponse, error) {
...
func (fake *Transactor) SendTransactionProposalCallCount() int {
...
func (fake *Transactor) SendTransactionProposalArgsForCall(i int) (*fab.TransactionProposal, []fab.ProposalProcessor) {
	fake.sendTransactionProposalMutex.RLock()
	defer fake.sendTransactionProposalMutex.RUnlock()
	return fake.sendTransactionProposalArgsForCall[i].arg1, fake.sendTransactionProposalArgsForCall[i].arg2
}

func (fake *Transactor) SendTransactionProposalReturns(result1 []*fab.TransactionProposalResponse, result2 error) {
...
func (fake *Transactor) SendTransactionProposalReturnsOnCall(i int, result1 []*fab.TransactionProposalResponse, result2 error) {
	fake.SendTransactionProposalStub = nil
...
var _ fab.Transactor = new(Transactor)

...
type PeerConfig struct {
	...
	DBPartitionTypeStub        func() string
	dBPartitionTypeMutex       sync.RWMutex
	dBPartitionTypeArgsForCall []struct{}
	dBPartitionTypeReturns     struct {
		result1 string
	}
	dBPartitionTypeReturnsOnCall map[int]struct {
		result1 string
	}
...
func (fake *PeerConfig) DBPartitionType() string {
	fake.dBPartitionTypeMutex.Lock()
	ret, specificReturn := fake.dBPartitionTypeReturnsOnCall[len(fake.dBPartitionTypeArgsForCall)]
	fake.dBPartitionTypeArgsForCall = append(fake.dBPartitionTypeArgsForCall, struct{}{})
	fake.recordInvocation("DBPartitionType", []interface{}{})
	fake.dBPartitionTypeMutex.Unlock()
	if fake.DBPartitionTypeStub != nil {
		return fake.DBPartitionTypeStub()
	}
	if specificReturn {
		return ret.result1
	}
	return fake.dBPartitionTypeReturns.result1
}

func (fake *PeerConfig) DBPartitionTypeCallCount() int {
	fake.dBPartitionTypeMutex.RLock()
	defer fake.dBPartitionTypeMutex.RUnlock()
	return len(fake.dBPartitionTypeArgsForCall)
}

func (fake *PeerConfig) DBPartitionTypeReturns(result1 string) {
	fake.DBPartitionTypeStub = nil
	fake.dBPartitionTypeReturns = struct {
		result1 string
	}{result1}
}
...
func (fake *PeerConfig) DBPartitionTypeReturnsOnCall(i int, result1 string) {
	fake.DBPartitionTypeStub = nil
	if fake.dBPartitionTypeReturnsOnCall == nil {
		fake.dBPartitionTypeReturnsOnCall = make(map[int]struct {
			result1 string
		})
	}
	fake.dBPartitionTypeReturnsOnCall[i] = struct {
		result1 string
	}{result1}
}
